<template>
  <div class="app-container">
    <!--查询  -->
    <el-row>
      <el-input style="width:200px;" v-model="tableQuery.nick" placeholder="学生名"></el-input>
    ...
    <el-table style="width: 100%"
      ...
      <el-table-column prop="uid" label="学生学号"></el-table-column>
      <el-table-column prop="uname" label="登录名"></el-table-column>
      <el-table-column prop="nick" label="学生名"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="20%">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="120px">
        ...
        <el-form-item label="学生名" prop="nick">
